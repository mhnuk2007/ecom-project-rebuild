...
public class ProductService {
    ...
    public String generateDescription(String name, String category) {
        String descPrompt = String.format("""
                Write a concise ande professional description for an e-commerce listing.
                
                Product Name: %s
                Category: %s
                
                Keep it simple, engaging, and highlight its primary feature or benefits.
                Avoid technical jargon and keep it customer friendly.
                
                Limit the description to 250 character maximum.
                
                Do not exceed 250 characters under any condition, it is hard limit.
                """, name, category
        );
        System.out.println(descPrompt);
